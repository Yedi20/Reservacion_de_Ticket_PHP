...
<html>
	<head>
		<title>Enviar datos de pago</title>
	</head>
	<body>
		<?php
			if(isset($_POST['Pay_Now']))
			{
				...
				*/
				...
				else
				{
					...
					/*$response=@mysqli_query($dbc,$query);
					Ese codigo que esta aerriba es solucionando este problema de aui abajo, 
					lo que quiere decir que lo este de aqui bajo tambien va arriba. en caso de
					*/
				}
				mysqli_close($dbc);
			}
