	...
	<body>
		...
		<div>
			<ul>
				...
				<li><a href="home_page.php"><i class="fa fa-sign-out" aria-hidden="true"></i> Cerrar sesión</a></li>
			</ul>
		</div>
		<form action="deactivate_jet_details_form_handler.php" method="post">
			<h2>ENTRAR EN EL AVIÓN PARA SER DESACTIVADO</h2>
			<div>
			<?php
			...
			<table cellpadding="5" style="padding-left: 20px;">
				<tr>
					<td class="fix_table">Introduzca un Jet ID válido</td>
				</tr>
				<tr>
