...
<html>
	...
	<body>
		...
		<?php
			echo "<h2>Bienvenido/a ".$_SESSION['login_user']."</h2>";
		...
		<table cellpadding="5">
			<tr>
				<td class="admin_func"><a href="book_tickets.php"><i class="fa fa-plane" aria-hidden="true"></i> Reservar billetes de avión</a>
				</td>
			</tr>
			<tr>
				<td class="admin_func"><a href="view_booked_tickets.php"><i class="fa fa-plane" aria-hidden="true"></i> Ver billetes de avión reservados</a>
				</td>
			</tr>
			<tr>
				<td class="admin_func"><a href="cancel_booked_tickets.php"><i class="fa fa-plane" aria-hidden="true"></i> Cancelar billetes de avión reservados</a>
				</td>
			</tr>
		</table>
		...
		<footer>
			...
			<!--<div id="footer">
			<div class="container">
				<p class="text-muted credit">DRECHOS RESERVADOS @SECURITY FLAS </p>
			</div>
			</div>
		-->
       </footer>
