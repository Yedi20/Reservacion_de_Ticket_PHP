...
<html>
	...
	<body>
		...
		<form action="payment_details_form_handler.php" method="post">
			<h2>INTRODUZCA LOS DATOS DE PAGO</h2>
			<h3 style="margin-left: 30px"><u>Resumen de pagos</u></h3>
			<?php
			...
			<table cellpadding="5" style='margin-left: 50px'>
				<tr>
					<td class="fix_table"><strong>Introduzca el modo de pago:-</strong></td>
				</tr>
				<tr>
					<td class="fix_table"><i class="fa fa-credit-card" aria-hidden="true"></i> tarjeta de crédito <input type="radio" name="payment_mode" value="credit card" checked></td>
					<td class="fix_table"><i class="fa fa-credit-card-alt" aria-hidden="true"></i>  tarjeta de débito <input type="radio" name="payment_mode" value="debit card"></td>
					<td class="fix_table"><i class="fa fa-desktop" aria-hidden="true"></i> Internet Banking <input type="radio" name="payment_mode" value="net banking"></td>
				</tr>
			</table>
			<br>
