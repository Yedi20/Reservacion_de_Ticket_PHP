	...
	<body>
		...
		<div>
			<ul>
				...
				<li><a href="home_page.php"><i class="fa fa-phone" aria-hidden="true"></i> Contatanos</a></li>
				<li><a href="logout_handler.php"><i class="fa fa-sign-out" aria-hidden="true"></i> Cerrar sesión</a></li>
			</ul>
		</div>
		<h2>VER BILLETES DE AVIÓN RESERVADOS</h2>
		<h3 class='set_nice_size'><center><u>Próximos viajes</u></center></h3>
		<?php
			...
			{
				echo "<h3><center>Sin próximos viajes!</center></h3>";
			}
			else
			{
			...
			echo "<br><h3 class=\"set_nice_size\"><center><u>Viajes completados</u></center></h3>";
			...
			if(mysqli_stmt_num_rows($stmt)==0)
			{
				echo "<h3><center>¡No hay viajes completados en los últimos 30 días!</center></h3>";
			}
			else
			{
				echo "<table cellpadding=\"10\"";
