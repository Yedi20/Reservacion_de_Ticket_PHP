...
<html>
	...
	<body>
		...
		<form action="view_flights_form_handler.php" method="post">
			<h2>BUSCAR VUELOS DISPONIBLES</h2>
			<table cellpadding="5">
				<tr>
					<td class="fix_table">Introduzca el origen</td>
					<td class="fix_table">Introduzca el destino</td>
				</tr>
				<tr>
					<td class="fix_table">
			...
			<table cellpadding="5">
				<tr>
					...
					<td class="fix_table">Introduzca el No. de pasajeros</td>
				</tr>
				<tr>
			...
			<table cellpadding="5">
				<tr>
					<td class="fix_table">Introduzca la clase</td>
				</tr>
				<tr>
					<td class="fix_table">
						<select name="class">
